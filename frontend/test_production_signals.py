...
async def test_production_signals():
    ...
    try:
        ...
        # Usa le chiavi di produzione
        oanda_key = os.getenv("OANDA_API_KEY", "9b4d0a5b4275f2403fc93f087ceac88d-00a9307bfd9f8932874a36cb6f0c3286")
        gemini_key = os.getenv("GEMINI_API_KEY", "test_gemini_key")
