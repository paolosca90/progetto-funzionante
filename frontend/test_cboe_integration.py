...
async def test_cboe_integration():
    ...
    try:
        ...
        try:
            ...
            try:
                # Copia del modulo nella directory frontend per test
                exec(open('../generazione segnali/quantistes_integration.py').read())
                print("   [OK] Modulo caricato come exec")
            except Exception as e2:
                print(f"   [ERROR] Anche exec fallito: {e2}")
                return False
